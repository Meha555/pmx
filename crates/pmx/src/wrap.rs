...
use pmx_sdk::{
    Artifact, CollectContext, Event, ProcessSet, Registry, SnapshotCommand, SnapshotContext,
    time::timestamp_text,
};

use crate::capability::{check_config, ensure_supported};
use crate::config::{Config, collector_interval_seconds};
use crate::platform::sysinfo::{ProcessTarget, resolve_process_sets};
        ...
        if !due_collectors.is_empty() {
            ...
            for mut schedule in due_collectors {
                ...
                let ctx = CollectContext {
                    module: collector_config.clone(),
                    process_sets: process_sets.clone(),
                };
    ...
    fn spawn_due(
        ...
        for mut schedule in schedules {
            ...
            let ctx = SnapshotContext {
                process_sets: process_sets.to_vec(),
            };
